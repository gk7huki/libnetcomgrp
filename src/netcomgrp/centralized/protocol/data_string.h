#ifndef _NETCOMGRP_CENTRALIZED_PROTOCOL_DATA_STRING_H_
#define _NETCOMGRP_CENTRALIZED_PROTOCOL_DATA_STRING_H_
...
#endif // _NETCOMGRP_CENTRALIZED_PROTOCOL_DATA_STRING_H_
