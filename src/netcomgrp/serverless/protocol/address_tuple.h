#ifndef _NETCOMGRP_SERVERLESS_PROTOCOL_ADDRESS_TUPLE_H_
#define _NETCOMGRP_SERVERLESS_PROTOCOL_ADDRESS_TUPLE_H_
...
namespace protocol {
	...
	public:
		...
		// access directly other nodes (NATted nodes might experience problems)
...
#endif //_NETCOMGRP_SERVERLESS_PROTOCOL_ADDRESS_TUPLE_H_
